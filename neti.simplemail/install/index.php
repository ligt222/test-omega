...
class neti_simplemail extends CModule
{
    ...
    public function doInstall()
    {
        ...
        if (!ModuleManager::isModuleInstalled($this->MODULE_ID)) {
            $step = IntVal($step);
            if ($step < 2) {
                $APPLICATION->IncludeAdminFile(Loc::GetMessage('MODULE_NETI_SIMPLEMAIL_INSTALL'), $this->modulePath . '/install/step1.php');
            } elseif ($step == 2) {
                COption::SetOptionString($this->MODULE_ID, "iblock", $_REQUEST['iblock']);
                ...
                if ($_REQUEST['iblock'] && CModule::IncludeModule($this->MODULE_ID)) {
                    SimpleMail::getPropIblock($_REQUEST['iblock']);
                }
    ...
    public function doUninstall()
    {
        ...
        if (CModule::IncludeModule($this->MODULE_ID)) {
            ...
            if ($step < 2) {
                ...
                SimpleMail::delPropIblock(COption::getOptionInt($this->MODULE_ID, 'iblock'));
